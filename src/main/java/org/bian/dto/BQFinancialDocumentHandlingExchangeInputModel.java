...
/**
 * BQFinancialDocumentHandlingExchangeInputModel
 */
public class BQFinancialDocumentHandlingExchangeInputModel   {
  ...
  private CRATMNetworkOperatingSessionExchangeInputModelATMNetworkOperatingSessionExchangeActionRequest financialDocumentHandlingExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get financialDocumentHandlingExchangeActionRequest
   * @return financialDocumentHandlingExchangeActionRequest
  **/

  public CRATMNetworkOperatingSessionExchangeInputModelATMNetworkOperatingSessionExchangeActionRequest getFinancialDocumentHandlingExchangeActionRequest() {
    return financialDocumentHandlingExchangeActionRequest;
  }

  public void setFinancialDocumentHandlingExchangeActionRequest(CRATMNetworkOperatingSessionExchangeInputModelATMNetworkOperatingSessionExchangeActionRequest financialDocumentHandlingExchangeActionRequest) {
    this.financialDocumentHandlingExchangeActionRequest = financialDocumentHandlingExchangeActionRequest;
  }
